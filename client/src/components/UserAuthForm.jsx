  ...
  const userAuthThroughServer = async (serverRoute, formData) => {
    try {
      ...
      if (error.response) {
        ...
        toast.error("please enter valid email and passwrod");
      }
    }
  };
        ...
        <form className="w-[80%] max-w-[400px]" onSubmit={handleSubmit}>
          {location.pathname == "/admin/signin" && (
            <Link to="/admin/signin">
              <p className="ml-[130px] text-3xl">Admin login</p>
            </Link>
          )}
          {/* {location.pathname == "/admin/signin" && (
            <Link to="/signup">
          ...
          {/* Conditionally render the Admin Sign In Button */}
          {location.pathname !== "/admin/signin" && ( // Hide button on /admin/signin
            <Link to="/admin/signin">
              ...
              <button className="btn-dark center mt-14 ml-[130px]">
                Admin Sign In
              </button>
            </Link>
          )}
